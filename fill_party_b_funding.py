...
LABEL = "for all expenses related to the property"
KEY = "funding_partner1_funding"
BALLOT_BOX = "☐"
...
def process_doc():
    ...
    # Iterate over paragraphs to find the one containing the label
    for para in doc.paragraphs:
        if LABEL in para.text:
            ...
            parts = [
                ...
                formatted_value,
                " ",
                "for all expenses related to the property acquisition, closing costs, TC fees and property renovation costs."
            ]
            for text in parts:
